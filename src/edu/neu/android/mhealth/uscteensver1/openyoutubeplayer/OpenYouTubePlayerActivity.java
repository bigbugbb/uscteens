package edu.neu.android.mhealth.uscteensver1.openyoutubeplayer;
...
import edu.neu.android.mhealth.uscteensver1.video.MoviePlayerHelper;
 ...
 *
 */
public class OpenYouTubePlayerActivity extends BaseActivity {
	
	public static final String TAG="OpenYouTubePlayerActivity";
	...
	protected String      mMsgToken      = "Loading...";
	...
	public void onCreate(Bundle pSavedInstanceState) {
		super.onCreate(pSavedInstanceState,TAG);
	...
	public void onPause() {
		super.onPause();
		try {
			double percentage = mVideoView.getCurrentPosition() / (double) mVideoView.getDuration();
			if (percentage > 0)
				MoviePlayerHelper.savePlayedMovie(mVideoId, 
					new java.text.DecimalFormat("#.00").format(percentage));
		} catch (TeenException e) {
			e.printStackTrace();
		}
