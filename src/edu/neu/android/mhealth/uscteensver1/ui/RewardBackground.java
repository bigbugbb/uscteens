...
public class RewardBackground extends Background {
	...
	public RewardBackground(Resources res) {
		...
		mPaintText1.setTypeface(Typeface.createFromAsset(TeensGlobals.sContext.getAssets(), "font/arial.ttf"));
		...
		mPaintText2.setTypeface(Typeface.createFromAsset(TeensGlobals.sContext.getAssets(), "font/arial.ttf"));
